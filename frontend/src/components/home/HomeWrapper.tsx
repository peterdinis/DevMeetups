					...
					<VStack gap="48px" textAlign="center">
						<VStack gap="32px" maxW="700px" mx="auto">
							...
							<Text
								...
								maxW="600px"
							>
								Whatever your interest in tech, from React and Node.js to AI and
								startups, there are thousands of developers who share it on
								DevMeetup. Events are happening every day—sign up to join the
								fun.
							</Text>
								...
								{[
									{
										...
										title: "Join a group",
										description:
											"Find communities that match your interests and passions",
									},
									{
										icon: "📅",
										title: "Find an event",
										description:
											"See what's happening in your developer community",
									},
									{
										icon: "💬",
