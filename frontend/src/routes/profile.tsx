        ...
        <Container maxW="container.md" py={12}>
            ...
            >
                <VStack gap={6} align="start">
                    <Flex align="center" gap={6} w="full" direction={{ base: 'column', sm: 'row' }}>
                        <Box
                            w={24}
                            h={24}
                            bg="blue.500"
                        ...
                        <Box flex="1" textAlign={{ base: 'center', sm: 'left' }}>
                            <Heading size="xl" mb={1}>{user.displayName}</Heading>
                            <Text color="gray.500" fontSize="lg">{user.email}</Text>
                            <Text color="gray.400" fontSize="sm" mt={1}>ID: {user.id}</Text>
                        </Box>
                    ...
                    <Box w="full" pt={6} borderTop="1px" borderColor={borderColor}>
                        ...
                        <VStack align="start" gap={3}>
                            <Box>
                                <Text fontWeight="medium" color="gray.500" fontSize="sm">Display Name</Text>
                                <Text>{user.displayName}</Text>
                            </Box>
                            <Box>
                                <Text fontWeight="medium" color="gray.500" fontSize="sm">Email Address</Text>
