...
const EventsWrapper: FC = () => {
	...
	const events: Event[] = [
		{
			...
			description:
				"Advanced TypeScript patterns and best practices for React developers. Learn how to build type-safe applications with real-world examples.",
			date: "2024-01-20",
			time: "14:00",
		...
		},
		{
			...
			description:
				"Build scalable microservices with Node.js, Docker, and Kubernetes. Hands-on workshop with practical examples.",
			date: "2024-01-22",
			time: "18:30",
		...
		},
		{
			...
			description:
				"Exploring the latest trends in AI and ML with practical demonstrations and networking opportunities.",
			date: "2024-01-25",
			time: "17:00",
		...
		},
		{
			...
			description:
				"Comprehensive workshop covering frontend and backend development with modern tools and frameworks.",
			date: "2024-01-28",
			time: "10:00",
		...
		},
		{
			...
			description:
				"Connect with fellow startup founders, investors, and tech enthusiasts. Share experiences and build partnerships.",
			date: "2024-02-01",
			time: "19:00",
		...
		},
		{
			...
			description:
				"Deep dive into modern DevOps practices, CI/CD pipelines, and cloud infrastructure management.",
			date: "2024-02-05",
			time: "16:00",
		...
		},
		{
			...
			description:
				"Learn about smart contracts, decentralized applications, and the future of web technology.",
			date: "2024-02-10",
			time: "15:00",
		...
		},
		{
			...
			description:
				"Comprehensive guide to building cross-platform mobile applications with React Native and Flutter.",
			date: "2024-02-15",
			time: "11:00",
		...
		},
		{
			...
			description:
				"Connect with fellow open source enthusiasts and learn how to contribute to major projects.",
			date: "2024-02-20",
			time: "18:00",
			location: "Virtual Event",
			locationType: "online",
	...
	const filteredAndSortedEvents = useMemo(() => {
		let filtered = events.filter((event) => {
			...
			return (
				matchesSearch && matchesCategory && matchesEventType && matchesPrice
			);
		});
	...
	const activeFiltersCount = Object.values(filters).filter(
		(value) => value !== "" && value !== "All" && value !== "date",
	).length;
							...
							<VStack gap="24px" align="start" width="100%">
								...
								<Box>
									...
									<Text
										...
										lineHeight="1.6"
									>
										Connect with developers who share your passions. Learn
										together, build together, and grow your network through
										amazing events and communities.
									</Text>
								</Box>
